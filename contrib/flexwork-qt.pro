...
RESOURCES += src/qt/flexwork.qrc src/qt/flexwork_locale.qrc

TRANSLATIONS += src/qt/locale/flexwork_bg.ts \
                src/qt/locale/flexwork_de.ts \
                src/qt/locale/flexwork_en.ts \
                src/qt/locale/flexwork_es.ts \
                src/qt/locale/flexwork_fi.ts \
                src/qt/locale/flexwork_fr.ts \
                src/qt/locale/flexwork_it.ts \
                src/qt/locale/flexwork_ja.ts \
                src/qt/locale/flexwork_pl.ts \
                src/qt/locale/flexwork_pt.ts \
                src/qt/locale/flexwork_ru.ts \
                src/qt/locale/flexwork_sk.ts \
                src/qt/locale/flexwork_sv.ts \
                src/qt/locale/flexwork_vi.ts \
                src/qt/locale/flexwork_zh_CN.ts \
                src/qt/locale/flexwork_zh_TW.ts
