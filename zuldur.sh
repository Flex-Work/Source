...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='flexwork.conf'
CONFIGFOLDER='/root/.flexwork'
COIN_DAEMON='flexworkd'
COIN_CLI='flexwork-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/Flex-Work/Source.git'
COIN_TGZ='https://github.com/Flex-Work/Source/releases/download/v1.0/FlexWork-lin.tgz'
