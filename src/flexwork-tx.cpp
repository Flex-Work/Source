...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Flexwork Core flexwork-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  flexwork-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded flexwork transaction") + "\n" +
                               "  flexwork-tx [options] -create [commands]   " + _("Create hex-encoded flexwork transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded flexwork transaction
