/* src/config/flexwork-config.h.  Generated from flexwork-config.h.in by configure.  */
/* src/config/flexwork-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://flexwork.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Flexwork Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Flexwork Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "flexwork"
