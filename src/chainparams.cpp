...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x00000e791435eb7f366125cc946e733d99994f2c32c741b27b27e5177ebcebc5"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1550042306, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 1000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "Flexwork coin";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1550042306;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21003262;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x00000e791435eb7f366125cc946e733d99994f2c32c741b27b27e5177ebcebc5"));
        assert(genesis.hashMerkleRoot == uint256("0x8ca91bc658d5376fb503fc36011baf01a6ed62956b0eba0afa846437021cc36e"));
        

        vSeeds.push_back(CDNSSeedData("dns1.flexwork.group", "dns1.flexwork.group"));
        vSeeds.push_back(CDNSSeedData("dns2.flexwork.group", "dns2.flexwork.group"));
        vSeeds.push_back(CDNSSeedData("dns3.flexwork.group", "dns3.flexwork.group"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
        ...
        nStartMasternodePayments = 1550042306; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1550042307;
        genesis.nNonce = 23600597;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000b2af9068f5463afeb61e31361b76064d23349230068b03937921afcf8f0"));
        ...
        // Testnet Flexwork BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Flexwork BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Flexwork BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1550042307;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1550042308;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 2;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x763534daf24a451f569b2013cad85adc27fce32e5c16eac5d2effb9717b315d7"));
