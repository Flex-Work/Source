...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Flexwork server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Flexwork server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FLX features */
        {"flexwork", "masternode", &masternode, true, true, false},
        {"flexwork", "masternodelist", &masternodelist, true, true, false},
        {"flexwork", "mnbudget", &mnbudget, true, true, false},
        {"flexwork", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"flexwork", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"flexwork", "mnsync", &mnsync, true, true, false},
        {"flexwork", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"flexwork", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use flexworkd, or the -server option to flexwork-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Flexwork Alert\" admin@foo.com\n"),
...
{
    return "> flexwork-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32922/\n";
}
