...
{
    // Convert flexwork:// to flexwork:
    //
    //    Cannot handle this later, because flexwork:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open flexwork.conf with the associated application */
...
{
    return GetAutostartDir() / "flexwork.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a flexwork.desktop file to the autostart directory:
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the flexwork app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add flexwork app to startup item list
