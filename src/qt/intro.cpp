...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Flexwork Core"),
     ...
     * override -datadir in the flexwork.conf file in the default data directory
     * (to be consistent with flexworkd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
