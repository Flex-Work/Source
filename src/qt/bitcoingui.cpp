                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Flexwork-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Flexwork address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and flexwork: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Flexwork Core"), this);
    aboutAction->setStatusTip(tr("Show information about Flexwork Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Flexwork"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Flexwork addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Flexwork addresses"));
    ...
    openAction->setStatusTip(tr("Open a Flexwork: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Flexwork Core help message to get a list with possible Flexwork command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Flexwork Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Flexwork network", "", count));
}
...
{
    QString strTitle = tr("Flexwork Core"); // default title
